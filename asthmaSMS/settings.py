# Django settings for asthmaSMS project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a asthmaSMS directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'asthmaSMS')
...
SECRET_KEY = 'zkp=3=9+rcw1!vw^ug-vz1lq!4qe1-(rubw8k7i$jn6($=h=_-'
...
ROOT_URLCONF = 'asthmaSMS.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'asthmaSMS.wsgi.application'
